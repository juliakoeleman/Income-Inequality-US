...
Using this measure, inequality will be visualized across sub-populations by grouping states into four categories - Low, Medium Low, Medium High and High - based on the percentage of the population with a bachelor's degree or higher. Additionally, inequality will be shown over time by presenting the mean and median values of all U.S. states.
