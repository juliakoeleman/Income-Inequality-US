...
---
"The Effect of Education Level on Income Inequality"
"Names + Studentnumbers"
date: "`r Sys.Date()`"
output: pdf_document
---
...
ggplot(data = Allmerged[Allmerged$Year == 2000, ], aes(x = Bachelor_level, y = Top10_vs_bottom90)) +
  geom_boxplot() +
  labs(
