...
##2.2 Short summary of data sets
...
#Reshape the Education dataset to the same form as the others so you
have a variable Year, and for every state a row in 1990 and 2000
...
measuring, but we don't have more data on the distribution of income.
