...
This Top10_vs_bottom90 ratio reflects income concentration at the top relative to the vast majority of the population and provides a broad, interpretable measure of inequality. 

Using this measure, inequality will be visualized over time by presenting the mean and median values of all U.S. states. Additionally, a second variable groups states into four categories - Low, Medium Low, Medium High, and High - based on the percentage of the population with a bachelor's degree or higher, allowing inequality to be visualized across sub-populations.
