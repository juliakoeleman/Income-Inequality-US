...
#Title Page
Carlijn Calori, Leah Delikát, Sten Groen, Julia Koeleman, Anne Schrama, Marie-Louise Stevens, Sophia Zentgraf
Tutorial Group 1
J.F. Fitzgerald
...
```{r loading data}
#<<<<<<< HEAD
EducationLevelData <- read.csv2("data/Frank_WID_2020.csv")
IncomeData <- read.csv2("data/tabn012.csv")
#=======
EducationLevelData <- read.csv2()
IncomeData <- read.csv()
#>>>>>>> 3c0d8e7370bc2e1e1368bdc252175b728bfd512f
```
