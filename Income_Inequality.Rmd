...
```
#Title Page
Carlijn Calori, Leah Delikát, Sten Groen, Julia Koeleman, Anne Schrama, Marie-Louise Stevens, Sophia Zentgraf, Fadhil Dhafir 
Tutorial Group 1
J.F. Fitzgerald
...
##2.1 Load in Data
```{r loading data}
EducationLevelData <- read.csv2("Data Inkomen.csv")
IncomeData <- read.csv2("Data Opleidingsniveau.csv")
```
...
jveyidiwquvdo
library(readxl)
tabn012_csv <- read_excel("Downloads/tabn012.csv.xlsx", 
